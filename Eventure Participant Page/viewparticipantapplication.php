...
$studentQuery = "
    SELECT s.first_name, s.last_name, s.email, s.matric_no, s.phone, s.ic, s.college, s.year_course, s.gender, ep.registration_status, ep.requirements
    FROM students s
...
<body>
    ...
    <main>
        ...
        <p><strong>Requirements:</strong> <?php echo htmlspecialchars($student['requirements']); ?></p>
        </section>
